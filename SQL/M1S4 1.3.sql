...
END
  ...
  CASE
    WHEN sales_summary.Last_order_date IS NULL THEN 'Inactive'
    WHEN DATE_DIFF(latest_order_date.max_order_date, sales_summary.Last_order_date, DAY) <= 365 THEN 'Active'
    ELSE 'Inactive'
END
  AS Customer_Status
FROM
